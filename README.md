...
| Platos     | `/api/plates/`    | GET, POST, PUT... | CRUD de platos con categorías     |
...
router.register(r'plates', ProductsViewSetGet, basename='plates')
...
Base de datos SQLite por defecto, puedes cambiar a PostgreSQL en core/settings.py.
